...
class _LeadPageState extends State<LeadPage> {
          ...
          children: <Widget>[
            ...
            AppBar(
              ...
              title: Text(
                ...
                style: TextStyle(color: kMilkWhiteColor, fontSize: 20, fontWeight: FontWeight.bold),
              ),
              actions: [
                GestureDetector(
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    color: ColorsTheme.greyBlue, borderRadius: BorderRadius.circular(25)),
                child: Icon(
                  Icons.add,
                  color: kMilkWhiteColor,
  ...
  Widget _buildTitle({String title = "Example Title", String imgUrl, Color color = Colors.black}) {
    return Padding(
        padding: EdgeInsets.symmetric(
            horizontal: DefaultSize.defaultPadding * 2, vertical: DefaultSize.smallSize),
              ...
              child: ScrollConfiguration(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      List<Activity> activityList = controller.activityList
                          .map((item) => Activity(
                                id: item["id"],
                                type: item["type"],
                                title: item["title"],
  ...
  void _createQB() {
    ...
    Get.bottomSheet(
        ...
        shape: CustomRoundedRectangleBorder(
          borderRadius: BorderRadius.vertical(top: Radius.circular(DefaultSize.middleSize * 2)),
          borderWidth: 10.0,
