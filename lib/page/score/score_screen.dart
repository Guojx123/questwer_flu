        ...
        children: [
          ...
          Column(
            children: [
              ...
              Text(
                "score.title".tr,
                style: Theme.of(context).textTheme.headline3.copyWith(color: ColorsTheme.greyWhite),
              ),
              Spacer(),
              Text(
                "${_qnController.numOfCorrectAns * 10}/${_qnController.questionList.length * 10}",
                style: Theme.of(context).textTheme.headline4.copyWith(color: ColorsTheme.greyWhite),
              ),
              Spacer(flex: 2),
              GestureDetector(
                onTap: () {
