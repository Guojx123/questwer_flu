...
class ActivityCard extends StatelessWidget {
  ...
  const ActivityCard({Key key, this.valueNotifier, this.activity, this.gradientLength})
      : super(key: key);
      ...
      builder: (context, value, widget) {
        return GestureDetector(
          ...
          child: Card(
            ...
            child: Container(
              width: PersistentStorage.screenWidth - (DefaultSize.middleSize * 4),
              child: Row(
                children: [
                  Padding(
                  ...
                  Expanded(
                    child: GradientImageWidget(
                        gradientLength: gradientLength, imageUrl: activity.imgUrl),
                  ),
                ],
              ),
            ),
